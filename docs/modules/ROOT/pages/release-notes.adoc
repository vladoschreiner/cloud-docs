...
- Introducing C++ client for Hazelcast 5 clusters. Follow the code sample, connect your C++ app to the cloud and use latest features of Hazeclast!

- Introducing new compact design for the cluster overview. 
